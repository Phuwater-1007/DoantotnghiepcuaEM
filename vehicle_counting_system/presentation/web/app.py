...
from vehicle_counting_system.presentation.web.routes import admin, api, auth, dashboard, media, monitoring, reports, ai_config, users, stream, brand_settings
...
def create_app() -> FastAPI:
    ...
    app.include_router(brand_settings.build_router(templates))
